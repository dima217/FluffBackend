...
export class CreateRecipeDto {
	...
	@ApiPropertyOptional({ example: 'https://example.com/promo.mp4', description: 'Promotional video URL' })
	@IsOptional()
	@IsString()
...
export class RecipeResponseDto {
	...
	@ApiPropertyOptional({ example: { id: 1, firstName: 'John', lastName: 'Doe' }, description: 'User who created the recipe' })
	user: {
		id: number;
		firstName: string;
		lastName: string;
