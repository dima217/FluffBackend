...
interface CodeSignupEmailProps {
	code: string;
	expirationMinutes: number;
	expirationDate: string;
}

export const CodeSignupEmail = ({
	code,
	expirationMinutes,
	expirationDate,
}: CodeSignupEmailProps) => {
	return (
		<Html>
			<Head />
			<Preview>Verification Code for Sign Up</Preview>
			<Body style={main}>
				<Container style={container}>
					...
					<Section style={content}>
						<Text style={text}>
							Спасибо за регистрацию! Для завершения регистрации используйте код подтверждения ниже:
						</Text>

						<Section style={codeBox}>
							<Text style={codeHint}>Your verification code:</Text>
						...
						<Section style={infoBox}>
							...
							<Text style={infoText}>
								Этот код действителен в течение {expirationMinutes} минут ({expirationDate}). Пожалуйста, используйте его как можно скорее.
							</Text>
						</Section>
...
export default CodeSignupEmail;
